...
static const struct ov7725_reg reg_tbl[] =
{
    ...
    {OV7725_COM4         , 0XC1}, // 0x40
    {OV7725_CLKRC        , 0X00}, // 0x00
    {OV7725_COM2         , 0x03},
    {OV7725_COM3         , 0xD0},
    {OV7725_COM7         , 0x40},
    {OV7725_HSTART       , 0x3F},
...
int8_t ov7725_probe(uint8_t ov7725_i2c_id, uint8_t i2c_instance)
{
    uint8_t dummy;
...
int8_t ov7725_set_image_size(ov7725_size size)
{
    switch(size)
    {
        case H_80_W_60:
